...
const Form = () => {
    ...
    const [nicknameRules,setNicknameRules] = useState<NicknameRules>({
        isNicknameLengthValid:true,
        isNicknameOnlyEnglishAlphabetValidation:true
    })
    ...
    const [passwordRules,setPasswordRules] = useState<PasswordRules>({
       isPasswordAtLeast8Characters:true,
       isPasswordHasAtLeast1SpecialCharacter:true,
       isPasswordHasAtLeastTwoCapitalLetters:true,
       isPasswordNoForeignCharacters:true, 
    })

    const [confirmPasswordRules,setConfirmPasswordRules] = useState<ConfirmPasswordRules>({
        isConfirmPasswordEqualToPassword:true
    })

    const [phonenumberRules,setPhonenumberRules] = useState<PhonenumberRules>({
        isPhonenumber11Digits:true
    })
  ...
  return (
    <form className='flex flex-col gap-4'>
        <div className={`flex ${(nicknameRules.isNicknameLengthValid && nicknameRules.isNicknameOnlyEnglishAlphabetValidation ? 'bg-WDS-sky-blue-75':'bg-WDS-red-75')} w-full px-5 rounded-md`}>
            <input 
        ...
        <div className={` ${emailRules.isEmailValid ? 'bg-WDS-sky-blue-75':'bg-WDS-red-75'} flex  w-full px-5 rounded-md`}>
        ...
        <div className={`${passwordRules.isPasswordAtLeast8Characters && passwordRules.isPasswordHasAtLeast1SpecialCharacter && passwordRules.isPasswordHasAtLeastTwoCapitalLetters && passwordRules.isPasswordNoForeignCharacters ?  'bg-WDS-sky-blue-75':'bg-WDS-red-75'} flex w-full px-5 rounded-md`}>
            <input
        ...
        <div className='flex bg-WDS-sky-blue-75 w-full px-5 rounded-md'>
            ...
            className=' placeholder-WDS-warm-gray-500 outline-none bg-transparent text-base font-medium py-3 w-full' 
        ...
        <div className='flex w-full flex-col gap-12'>
            <input className=' cursor-pointer flex w-full p-5 text-WDS-white-alpha-default tracking-widest bg-WDS-sky-blue-400 font-bold rounded-md justify-center items-center shadow-md shadow-WDS-sky-blue-200' 
            value='Register NOW!' 
            type="submit" />
